...
import { Wrench, ChevronDown, Menu, X, Phone, Crown } from 'lucide-react';
...
const Navbar = () => {
  ...
  const services = [
    ...
    { name: 'Commercial Appliance Repair', path: '/services/commercial-repair' },
        ...
        <div className="flex justify-between h-16">
          <div className="flex items-center">
            <Link to="/" className="flex items-center space-x-2">
              ...
              <span className="text-xl font-bold text-gray-800">LCAR</span>
            </Link>
          </div>

          {/* Desktop Navigation */}
          <div className="hidden md:flex items-center space-x-8">
            <Link to="/" className="font-bold text-gray-600 hover:text-emerald-600">Home</Link>
            <Link to="/about" className="font-bold text-gray-600 hover:text-emerald-600">About</Link>
            ...
            <Link to="/contact" className="font-bold text-gray-600 hover:text-emerald-600">Contact</Link>
