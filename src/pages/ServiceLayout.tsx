...
import { Phone, Shield, Clock, Wrench, Star, MapPin, DollarSign, CheckCircle } from 'lucide-react';
...
const ServiceLayout: React.FC<ServiceLayoutProps> = ({
  ...
  const processSteps = [
    ...
    },
    {
      number: "2",
      title: "Diagnosis",
      description: "Our technician will perform a thorough diagnostic assessment"
    },
    {
      number: "3",
  ...
  return (
    <div>
      ...
      <div className="relative h-[400px] mb-12">
        ...
        />
        <div className="absolute inset-0 bg-gradient-to-r from-emerald-900/80 to-emerald-600/80 flex items-center">
      ...
      <div className="py-16 bg-white">
        <div className="max-w-7xl mx-auto px-4">
          <div className="text-center mb-12">
            <h2 className="text-3xl font-bold mb-4 text-emerald-900">Our Process</h2>
      ...
      <div className="mb-16">
        <div className="max-w-7xl mx-auto px-4">
          <h2 className="text-3xl font-bold text-center mb-12 text-emerald-900">Why Choose Our Service</h2>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            {benefits.map((benefit, index) => (
              <div key={index} className="text-center p-6 bg-white rounded-lg shadow-lg hover:shadow-xl transition-shadow">
                <div className="flex justify-center mb-4">{benefit.icon}</div>
                <h3 className="text-xl font-bold mb-2 text-emerald-900">{benefit.title}</h3>
      ...
      <div className="max-w-7xl mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 mb-16">
          <div className="bg-white p-8 rounded-lg shadow-lg">
            <h2 className="text-2xl font-bold mb-6 text-emerald-900">Our Service Features</h2>
          ...
          <div className="bg-white p-8 rounded-lg shadow-lg">
            <h2 className="text-2xl font-bold mb-6 text-emerald-900">Common Issues We Fix</h2>
            <ul className="space-y-4">
        ...
        {/* Call to Action */}
        <div className="bg-gradient-to-r from-emerald-600 to-emerald-700 text-white rounded-xl p-8 text-center mb-16">
          <h2 className="text-3xl font-bold mb-4">Need {title}?</h2>
          <p className="text-xl mb-8">
            Our expert technicians are ready to help. Call now for fast, reliable service!
          </p>
          <a
            href="tel:+18477670547"
            className="inline-flex items-center bg-white text-emerald-700 px-8 py-3 rounded-md text-lg hover:bg-emerald-50 transition-colors"
